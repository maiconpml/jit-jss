...
function runTest() {
	...
	for ((i=$ini; i<$fin; i++)) {
		${exe} ${instance_dir}/${instances[i]} "`basename ${instances[i]} .psi` " --maxSecs 300.0  --seed 0 --maxC 2 --tenure 6 --initialjumpLimit 2809 --decreaseDivisor 6 --bjSize 4 --maxD 95 --acceptAlpha 0.2169 --perturbType insa --sizePInsa 33 --timeLog false
	}
}
